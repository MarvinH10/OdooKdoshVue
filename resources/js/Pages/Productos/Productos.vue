  ...
  try {
    ...
    if (attributeInputs.value.length) {
      productPayload.attributes = attributeInputs.value.map((input) => ({
        ...
        value_ids: input.selectedAttributeValues
          ? input.selectedAttributeValues.map((value) => parseInt(value))
          : [],
        extra_references: input.extraReferences.map(
          (ref, index) =>
            ref ||
            (input.selectedAttributeValues[index]
              ? productPayload.default_code
              : "")
        ),
        extra_prices: input.extraPrices,
      }));
    } else {
...
<template>
  <AppLayout title="Productos">
              ...
              <tbody>
                <tr v-for="(producto, index) in productos" :key="producto.id">
                  ...
                  <td class="px-6 py-4 border-b border-gray-300">
                    ...
                    >
                      <span
                        ...
                        :key="val"
                        class="tag"
                        >{{ getValueAttributeName(val) }}</span
                      >
                    </span>
                  </td>
                  <td class="px-6 py-4 border-b border-gray-300">
                    ...
                    >
                      <span
                        v-for="(ref, index) in attr.extra_references"
                        :key="index"
                        class="tag"
                        >{{ ref }}</span
                      >
                  ...
                  <td class="px-6 py-4 border-b border-gray-300">
                    ...
                    >
                      <span
                        v-for="(price, index) in attr.extra_prices"
                        :key="index"
                        class="tag"
                        >{{ price !== null ? "S/. " + price : "S/. 0" }}</span
                      >
                    </span>
                  </td>
                  <td class="px-6 py-4 border-b border-gray-300">
                  ...
                  <form @submit.prevent="registrarProducto">
                    ...
                    <div class="mb-4 flex flex-wrap gap-4">
                      ...
                      <div class="flex-1">
                        ...
                        <select
                          id="subcateg1_id"
                          v-model="producto.subcateg1_id"
                          :disabled="
                            !subcategories[1] || subcategories[1].length === 0
                          "
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        >
                          <option
                      ...
                      <div class="flex-1">
                        ...
                        <select
                          id="subcateg2_id"
                          v-model="producto.subcateg2_id"
                          :disabled="
                            !subcategories[2] || subcategories[2].length === 0
                          "
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        >
                          <option
                      ...
                      <div class="flex-1">
                        ...
                        <select
                          id="subcateg3_id"
                          v-model="producto.subcateg3_id"
                          :disabled="
                            !subcategories[3] || subcategories[3].length === 0
                          "
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        >
                          <option
                      ...
                      <div class="flex-1">
                        ...
                        <select
                          id="subcateg4_id"
                          v-model="producto.subcateg4_id"
                          :disabled="
                            !subcategories[4] || subcategories[4].length === 0
                          "
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        >
                          <option
                    ...
                    <div class="mb-4">
                      ...
                      <div
                        v-for="(input, index) in attributeInputs"
                        :key="index"
                      ...
                      >
                        <div class="flex-1">
                          ...
                          <select
                            :id="'attribute' + index"
                            v-model="input.selectedAttribute"
                            @change="
                        ...
                        <div class="flex-1">
                          <label
                            :for="'attribute_values' + index"
                            class="block text-gray-700 text-sm font-bold mb-2"
                          >
                            Valores de Atributo:
                          </label>
                          <select
                            :id="'attribute_values' + index"
                            v-model="input.selectedAttributeValues"
                            multiple
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                          >
                            <option
                        ...
                        <div class="flex-1 mt-0.5">
                          ...
                          >
                            <input
                              ...
                              v-model="input.extraReferences[refIndex]"
                        ...
                        <div class="flex-1 mt-8">
                          ...
                          <input
                            ...
                            v-model="input.extraPrices[priceIndex]"
    ...
    <!-- Modal para mostrar enlaces de los productos registrados -->
