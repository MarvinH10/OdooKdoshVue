...
class ServicioOdoo
{
    ...
    public function authenticate()
    {
        ...
        $this->reporteService = new ReporteService($this->modelos, $this->base_datos, $this->uid, $this->contraseña);
    ...
    {
        return $this->reposicionService->traerDatosReposicionxReferencia($default_code);
    }

    public function traerDatosReposicionxName($name)
    {
        return $this->reposicionService->traerDatosReposicionxName($name);
    }
    ...
    {
        return $this->reporteService->traerDatosOrdenCompra($parametro);
    }
    /*FIN BARCODE SERVICIO*/
}
